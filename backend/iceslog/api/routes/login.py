...
def recover_password(email: str, session: SessionDep) -> RetMsg:
    """
    Password Recovery
    """
    ...
    return RetMsg(message="Password recovery email sent")


@router.post("/reset-password/")
def reset_password(session: SessionDep, body: NewPassword) -> RetMsg:
    """
    Reset password
    """
